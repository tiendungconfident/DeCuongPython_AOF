#23. Tính tổng thành tiền đã bán trong tháng x năm 2023
...
while True:
    ...
    print(f"Tổng thành tiền đã bán trong tháng {x}: {total}")
    write_log(f"Tổng thành tiền đã bán trong tháng {x}: {total}")
